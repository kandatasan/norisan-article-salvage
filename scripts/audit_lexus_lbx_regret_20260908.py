...
UA='tsurikue-audit-lbx-regret-20260908/1.0'
SLUGS=['lexus-lbx-regret','lbx-regret','lexus-lbx-koukai','lbx-koukai']
SEARCHES=['レクサスLBX 後悔','LBX 後悔','レクサスLBX']
MEDIA_TERMS=['後悔しちゃうかも','3110','3099','3089','3087','3105','3106','3129']
RELATED_SLUGS=['lexus-ux-vs-lbx','lexus-ux-review','lexus-ux-rear-seat','lexus-ux-size','lexus-ux-used']
...
def main():
    print('# Audit: Lexus LBX regret new draft (GET only)')
