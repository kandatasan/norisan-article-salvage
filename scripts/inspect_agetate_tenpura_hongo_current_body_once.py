...
EXPECTED_TITLE = "『あつあつ揚立てっちゃん』本郷店。揚立て熱々すぎて最高！"
SALVAGE_MARKER = "<!-- old-tsurikue-salvage:v1 slug=agetate-tenpura-hongo -->"
REPORT_DIR = Path("reports/agetate-tenpura-hongo-current-body")
USER_AGENT = "tsurikue-agetate-tenpura-hongo-current-body-inspect/1.0"
...
def main() -> int:
    ...
    summary = (
        "# agetate-tenpura-hongo current WordPress draft body\n\n"
        "- mode: **READ ONLY**\n"
