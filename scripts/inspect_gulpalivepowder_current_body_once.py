...
# Final read-only verification after guarded WordPress apply.
# Recheck state before final source-grounding cleanup on 2026-08-22.
# Direct push-event diagnostic rerun; GET only, no WordPress write.
