...
SITE='https://tsurikue.com'; POST_ID=2329
UA='tsurikue-audit-ux300h-20260907/1.0'
...
def main():
    ...
    print('# ux300h funnel audit (GET only)')
    ...
    keys=('300h','250h','中古','価格','値段','査定','売却','売る','買う','乗り換え','予算','下取り','ガリバー','CTN')
