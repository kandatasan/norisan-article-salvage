...
H={'Authorization':'Basic '+token,'Content-Type':'application/json; charset=utf-8','User-Agent':'tsurikue-gourmet-hub/1.2'}
...
content=content.replace('__GOURMET_CATEGORY_ID__',str(cats[0]['id']))
