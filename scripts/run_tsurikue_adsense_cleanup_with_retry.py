#!/usr/bin/env python3
"""Run the AdSense cleanup with bounded retries for transient REST failures.

This wrapper never changes cleanup mode or payloads. It only retries URLError
failures and writes a sanitized diagnostic file without credentials.
"""
...
import tsurikue_adsense_cleanup as cleanup
...
def output_dir_from_argv() -> Path:
    try:
        ...
        return Path("reports/tsurikue-adsense-cleanup")
