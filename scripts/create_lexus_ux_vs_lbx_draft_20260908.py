...
UA='tsurikue-create-ux-vs-lbx-20260908/1.0'
TITLE='レクサスLBXとUXどっち？両方乗った元UXオーナーがサイズ・乗り心地・価格を比較'
SLUG='lexus-ux-vs-lbx'
CONTENT_PATH=Path('packages/lexus-ux-vs-lbx/content.html')
FEATURED=1513
CATEGORIES=[11]
TAGS=[36,37,42]
EXPECTED_MEDIA={
  1513:'/wp-content/uploads/2026/05/img_3110.jpg',
  1507:'/wp-content/uploads/2026/05/img_3099.jpg',
  1504:'/wp-content/uploads/2026/05/img_3106.jpg',
  1509:'/wp-content/uploads/2026/05/img_3129.jpg',
  1491:'/wp-content/uploads/2026/05/img_3087.jpg',
  1499:'/wp-content/uploads/2026/05/img_3105.jpg',
...
def main():
    ...
    assert '運転しやすっ！' in content and 'ヒザだけでなくスネ' in content and '427万円' in content
    assert '420万円' in content and '521万円' in content and '2027年2月' in content
    ...
    if existing:
        ...
        payload={
          ...
          'tags':TAGS,
          'excerpt':'レクサスUX250hを1万km以上所有し、LBXにも実際に試乗した元UXオーナーが、LBXとUXのサイズ・乗り心地・後席・荷室・価格を比較。新車LBXと中古UX250hまで含めて、どちらが向いているかを本音で解説します。'
        }
    ...
    print('# New Lexus UX vs LBX draft creation')
