...
POST_ID = 2651
SLUG = "sabiki-beginner"
EXPECTED_TITLE = "サビキ釣りの始め方｜堤防で家族と楽しむファミリーフィッシング入門"
SALVAGE_MARKER = "<!-- old-tsurikue-salvage:v1 slug=sabiki-beginner -->"
REPORT_DIR = Path("reports/sabiki-beginner-current-body")
USER_AGENT = "tsurikue-sabiki-beginner-current-body-inspect/1.0"
...
def main() -> int:
    ...
    summary = (
        "# sabiki-beginner current WordPress draft body\n\n"
        "- mode: **READ ONLY**\n"
