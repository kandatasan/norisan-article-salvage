...
SITE='https://tsurikue.com'; POST_ID=2874
UA='tsurikue-audit-lexus-ux-poor-20260907/1.0'
...
def main():
    ...
    print('# lexus-ux-poor funnel audit (GET only)')
    ...
    keys=('中古','予算','年収','貧乏','見栄','無理','下取り','査定','売る','売却','買う','ローン','価格')
