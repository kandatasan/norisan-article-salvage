...
UA='tsurikue-create-ux250h-used-vs-ux300h-20260908/1.0'
TITLE='レクサスUX250h中古とUX300h新車はどっち？元オーナーが今買うなら中古を選ぶ理由'
SLUG='lexus-ux250h-used-vs-ux300h'
CONTENT_PATH=Path('packages/lexus-ux250h-used-vs-ux300h/content.html')
FEATURED=2330
CATEGORIES=[10,11]
TAGS=[36,37]
EXPECTED_MEDIA={
  ...
  1352:'/wp-content/uploads/2026/05/img_2780.jpg',
  2952:'/wp-content/uploads/2026/08/IMG_1102.jpeg',
  1624:'/wp-content/uploads/2026/05/img_3494.jpg',
}
...
def main():
    ...
    if existing:
        ...
        payload={
          ...
          'tags':TAGS,
          'excerpt':'2027年2月で生産終了予定のレクサスUX。UX250hを約616万円で購入しUX300hにも試乗した元オーナーが、今買うなら中古250hと新車300hのどちらを選ぶか、価格・内装・走り・使い方から比較します。'
        }
    ...
    print('# New UX250h used vs UX300h draft creation')
