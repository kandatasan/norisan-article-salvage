...
EXPECTED_TITLE = "コタマガイ・オキアサリ採りのコツ｜海遊びで楽しむ貝採り体験記"
EXPECTED_CONTENT_SHA256 = "e447fb97c76a34db40e73f94138bc48b96ebc83698d9a6f9a03130b490ea38f1"
REPORT_DIR = Path("reports/kotamagai-source-body")
...
def main() -> int:
    ...
    summary = (
        "# kotamagai preserved source body\n\n"
