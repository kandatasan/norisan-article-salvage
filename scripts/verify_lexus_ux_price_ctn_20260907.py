...
UA='tsurikue-verify-lexus-ux-price-ctn-20260907/1.0'
...
def main():
    ...
    print('# lexus-ux-price post-apply verification')
    print('- result: **SUCCESS**')
    print('- wordpress_write_count: **0**')
    print('- status: **publish** / featured_media: **2223**')
    print('- Gulliver **1** / CTN banner **0** / CTN button **1**')
    print('- price-to-sale bridge: **present** / phone note: **present** / microcopy: **present**')
