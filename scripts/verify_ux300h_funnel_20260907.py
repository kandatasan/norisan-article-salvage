...
SITE='https://tsurikue.com'; POST_ID=2329; UA='tsurikue-verify-ux300h-20260907/1.0'
GULLIVER='[blog_parts id="2843"]'; CTN_BANNER='[blog_parts id="2846"]'; CTN_BUTTON='[blog_parts id="2184"]'; MARKER='<!-- tsurikue-ctn-ux300h-funnel:20260907 -->'
...
def main():
    ...
    assert row['id']==2329 and row['slug']=='ux300h' and row['status']=='publish' and row['featured_media']==2330
    assert raw(row,'title')=='レクサスUX300hを試乗｜UX250hオーナーが比較して感じた3つの違い'
    assert MARKER in c and '連絡が来たのは2社だけ' in c and '電話が少なくて快適でした' in c
    ...
    print('# ux300h post-apply verification')
    print('- result: **SUCCESS**')
    print('- wordpress_write_count: **0**')
    print('- status: **publish** / featured_media: **2330**')
    print('- Gulliver **1** / CTN banner **1** / CTN button **1**')
    print('- firsthand phone note: **present before CTN banner** / Gutenberg problems: **0**')
