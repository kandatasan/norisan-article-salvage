...
POST_ID = 2659
SLUG = "tougorouiwashi"
EXPECTED_TITLE = "トウゴロウイワシが釣れたら美味しく食べよう！"
SALVAGE_MARKER = "<!-- old-tsurikue-salvage:v1 slug=tougorouiwashi -->"
REPORT_DIR = Path("reports/tougorouiwashi-current-body")
USER_AGENT = "tsurikue-tougorouiwashi-current-body-inspect/1.0"
...
def main() -> int:
    ...
    summary = (
        "# tougorouiwashi current WordPress draft body\n\n"
        "- mode: **READ ONLY**\n"
